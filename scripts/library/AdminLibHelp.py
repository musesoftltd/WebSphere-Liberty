...
#
#------------------------------------------------------------------------------
# AdminLibHelp.py - Jython procedures for performing script libraryOld general help information.
#------------------------------------------------------------------------------
...
def help(library="", failonerror=AdminUtilities._BLANK_):
        ...
        try:
                ...
                # print " Script libraryOld name:            "+libraryOld
                # print " Usage: AdminLibHelp.help(\""+libraryOld+"\")"
                # print "---------------------------------------------------------------"
                # print " "
                # print " "
