...
# such damages.
###############################################################################
# @(#) 1.18 SERV1/ws/code/admin.scripting/src/scriptLibraries/resources/JMS/V61/AdminJMS.py, WAS.admin.scripting, WAS855.SERV1, cf041444.01 12/15/11 14:22:13 [11/7/14 10:43:16]
...
def help(procedure="", failonerror=AdminUtilities._BLANK_):
    ...
    try:
        ...
        # print " Return: Receive help information for the specified AdminJMS libraryOld function or provide help information on all of the AdminJMS script libraryOld functions if parameters are not passed" 
        # print "---------------------------------------------------------------"        
        # print " "
        # print " "
        bundleName = "com.ibm.ws.scripting.resources.scriptLibraryMessage"
