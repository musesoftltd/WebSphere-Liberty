...
###############################################################################
#
# @(#) 1.31 SERV1/ws/code/admin.scripting/src/scriptLibraries/servers/V61/AdminServerManagement.py, WAS.admin.scripting, WAS855.SERV1, cf041444.01 9/14/10 11:38:08 [11/7/14 10:41:24]
#
#-------------------------------------------------------------------------------------
...
def help(procedure="", failonerror=AdminUtilities._BLANK_):
    ...
    try:
        ...
        # print " Return: Receive help information for the specified script libraryOld function."
        # print "---------------------------------------------------------------"
        # print " "
        # print " "
