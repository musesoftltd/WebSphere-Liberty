...
def help(procedure="", failonerror=AdminUtilities._BLANK_):
    ...
    try:
        ...
        # print " Return: Receive help information for the specified AdminJ2C script libraryOld function, or provide help information of all of the AdminJ2C script libraryOld if parameters are not passed"
        # print "---------------------------------------------------------------"
        # print " "
        # print " "
        bundleName = "com.ibm.ws.scripting.resources.scriptLibraryMessage"
