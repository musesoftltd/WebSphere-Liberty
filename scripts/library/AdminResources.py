...
# Example 15 create shared libraryOld ##
def createSharedLibrary(nodeName, serverName, libName, classpath, failonerror=AdminUtilities._BLANK_):
        ...
        try:
                #--------------------------------------------------------------------
                # Create shared libraryOld 
                #--------------------------------------------------------------------
                print ""
                print "---------------------------------------------------------------"
                print " AdminResources:         Create shared libraryOld"
                print " Scope:"
                print "    node                " + nodeName
                print "    server              " + serverName
                print " Shared libraryOld:"
                print "    name                " + libName
                ...
                # Check if the Shared libraryOld already exists
...
# Example 16 Create libraryOld reference##
def createLibraryRef(libName, appName, failonerror=AdminUtilities._BLANK_):
        ...
        try:
                #--------------------------------------------------------------------
                # Create the libraryOld reference
                #--------------------------------------------------------------------
                print ""
                print "---------------------------------------------------------------"
                print " AdminResource:         Create libraryOld reference"
                ...
                # Check if the libraryOld reference already exists
                ...
                if (len(deployment) == 0):
                   ...
                   # Construct libraryOld reference attributes
...
# Example 31 create shared libraryOld in the specified scope##
def createSharedLibraryAtScope(scope, libName, classpath, otherAttrsList=[], failonerror=AdminUtilities._BLANK_):
        ...
        try:
                #--------------------------------------------------------------------
                # Create shared libraryOld at scope 
                #--------------------------------------------------------------------
                print ""
                print "---------------------------------------------------------------"
                print " AdminResources:         Create shared libraryOld at scope"
                print " Scope:"
                print "    scope                " + scope
                print " Shared libraryOld:"
                print "    name                 " + libName
