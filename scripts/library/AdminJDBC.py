...
def help(procedure="", failonerror=AdminUtilities._BLANK_):
    ...
    try:
        ...
        # print " Return: Receive help information for the specified AdminJDBC script libraryOld function or provide help information for all of the AdminJDBC script libraryOld functions if parameters are not passed"
        # print "---------------------------------------------------------------"
        # print " "
        # print " "
        bundleName = "com.ibm.ws.scripting.resources.scriptLibraryMessage"
