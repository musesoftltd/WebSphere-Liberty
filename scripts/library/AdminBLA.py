...
def help(procedure="", failonerror=AdminUtilities._BLANK_):
        ...
        try:
                ...
                # print " Return: List the help information for the specified AdminBLA libraryOld function or list the help information for all of the AdminBLA script libraryOld function if parameters are not passed."
                # print "---------------------------------------------------------------"
                # print " "
                # print " "
                bundleName = "com.ibm.ws.scripting.resources.scriptLibraryMessage"
