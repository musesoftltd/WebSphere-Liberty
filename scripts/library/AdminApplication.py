...
# # Example 40 Configure libraryOld reference for an application ##
def configureLibraryReferenceForAnApplication(appName, sharedLibrary, failonerror=AdminUtilities._BLANK_):
        ...
        try:
                ...
                #--------------------------------------------------------------------
                # An example to create a shared libraryOld reference for an application 
                #--------------------------------------------------------------------
                print "---------------------------------------------------------------"
                print " AdminApplication:       Configure shared libraryOld reference for an application "
                print " Application name:       " + appName
                print " Shared libraryOld name:    " + sharedLibrary
                ...
                if (len(deployment) == 0):
                   ...
                   # Create shared libraryOld through cloassloader
...
def help(procedure="", failonerror=AdminUtilities._BLANK_):
        ...
        try:
                ...
                # print " Return: List the help information for the specified AdminApplication script libraryOld function or list the help information for all of the AdminApplication script libraryOld functions if parameters are not passed. "
                # print "---------------------------------------------------------------"
                # print " "
                # print " "
                bundleName = "com.ibm.ws.scripting.resources.scriptLibraryMessage"
